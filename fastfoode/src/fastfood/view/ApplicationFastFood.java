...
public class ApplicationFastFood extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        lblManager.setIcon(new ImageIcon(ApplicationFastFood.class.getResource("/fastfood/img/License-manager-icon.png"))); // NOI18N
        ...
        lblConfirm.setIcon(new ImageIcon(ApplicationFastFood.class.getResource("/fastfood/img/confirm-security-icon.png"))); // NOI18N
        ...
        lblMyStore.setIcon(new ImageIcon(ApplicationFastFood.class.getResource("/fastfood/img/Clothing-Store-icon.png"))); // NOI18N
        ...
        lblQRcore.setIcon(new ImageIcon(ApplicationFastFood.class.getResource("/fastfood/img/Ecommerce-Qr-Code-icon.png"))); // NOI18N
        ...
        lblInforCart.setIcon(new ImageIcon(ApplicationFastFood.class.getResource("/fastfood/img/shopping-cart-icon.png"))); // NOI18N
                ...
                .addGroup(pnlInforProductLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlInforProductLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlInforProductLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlInforProductLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(lblInforNoteProduct, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(lblInforNameStore, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 264, Short.MAX_VALUE))))
                    .addGroup(pnlInforProductLayout.createSequentialGroup()
                        .addGap(82, 82, 82)
                        .addGroup(pnlInforProductLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlInforProductLayout.createSequentialGroup()
            ...
            .addGroup(pnlInforProductLayout.createSequentialGroup()
                ...
                .addGroup(pnlInforProductLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(pnlInforProductLayout.createSequentialGroup()
                        ...
                        .addGap(4, 4, 4)
                        .addComponent(lblInforNoteProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pnlInforProductLayout.createSequentialGroup()
        ...
        btnAdimndelete.setIcon(new ImageIcon(ApplicationFastFood.class.getResource("/fastfood/img/Trash-can-icon.png"))); // NOI18N
        ...
        btnExcel.setIcon(new ImageIcon(ApplicationFastFood.class.getResource("/fastfood/img/Microsoft-Excel-2013-icon.png"))); // NOI18N
        ...
        button1.setIcon(new ImageIcon(ApplicationFastFood.class.getResource("/fastfood/img/Microsoft-Word-2013-icon.png"))); // NOI18N
...
//            p.panel();
    ...
    private void reStoreProduct(UiProduct ui) {
        ui.btn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (Message.getconfirm(null, "Do you want restore this product?", "ReStore Product") == JOptionPane.YES_OPTION) {
...
//        new ScannerQrcode().setVisible(true);
    ...
    public void getLogin() {
        ...
        if (vl.multiReMatch(txtLoginUser, lblerrLoginUSer, "User", vl.reUser(), "User phải có 6 ký tự.(Bao gồm số và ký tự hoa)", 3)) {
            lblIconLoginUser.setIcon(Msg.v());
        }

        if (vl.multiReMatch(txtLoginPass, lblerrLoginPass, "Password", vl.reUser(), "Pass phải có 6 ký tự.(Bao gồm số và ký tự hoa)", 3)) {
    ...
    public void getRegister() {
        ...
        if (vl.multiReMatch(txtReUser, lblReErrorUSe, "User", vl.reUser(), "User phải có 6 ký tự.(Bao gồm số và ký tự hoa)", 3)) {
            lblIconReUserName.setIcon(Msg.v());
        }
        if (vl.multiReMatch(txtRePass, lblReErrorPass, "Password", vl.reUser(), "Pass phải có 6 ký tự.(Bao gồm số và ký tự hoa)", 3)) {
